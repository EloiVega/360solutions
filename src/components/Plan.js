...
const Plan = ({plan}) => {
  ...
  return (
    <div className={`w-11/12 md:w-full xl:w-1/4 h-136 p-5 rounded-3xl flex flex-col justify-start items-center shadow-xl border border-solid border-orange-500 ${plan.name === "Diamond"? `bg-gray-800  text-white ${styles.diamondBackground}`: plan.popular? "bg-gray-700 text-orange-400" : "bg-white"}`}>
